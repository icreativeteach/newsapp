	...
	<div class="sw-container">
		<div class="sw-page">
				...
				<div class="smart-bar__content">
				  	...
				  	<div class="smart-bar__actions custom-actions">
				  		<div class="sw-tooltip--wrapper">
				  			<a href="#" class="sw-button sw-button--primary btn-create-recipientgroup">
					  			<span class="sw-button__content">
					            	Create new reciptient group
					        	</span>
					        </a>
					    </div>
					</div>
			...
			<div class="sw-page__content">
						...
						<div class="sw-product-list__content">
							<div class="sw-data-grid">
								<div class="sw-data-grid__wrapper">
									<div class='sw-data-grid__bulk deleterecipientgroup-bulk'>
										<span class='sw-data-grid__bulk-selected sw-data-grid__bulk-selected-label'>Selected:</span>
										<span class='sw-data-grid__bulk-selected sw-data-grid__bulk-selected-count delete-recipientgroup-count'></span> 
										<span class='sw-data-grid__bulk-selected bulk-link'>
											<a class='link link-danger delete-selectedrecipientgroup'>Delete</a>
										</span>
									</div>
									<table class="sw-data-grid__table">
														...
														<div class="sw-field--checkbox sw-data-grid__select-all">
															<div class="sw-field--checkbox__content">
																<div class="sw-field__checkbox">
																	<input id="deleteAllRecipientgroup"type="checkbox" name="deleteAllRecipientgroup[]" class="deleteAllRecipientgroup">
                    					...
                    					<tbody class="sw-data-grid__body" id="recipientgroup-tbody">
                    						 <?php //dd($newsletterSender); ?>
                    						@foreach ($newsletterRecipientsGroup as $value)
                    						
                    						<tr class="sw-data-grid__row sw-data-grid__row--0 recipientgroup-{{ $value->id }}" id="{{ $value->id }}">
                    							<td class="sw-data-grid__cell sw-data-grid__cell--selection">
                    								<div class="sw-data-grid__cell-content">
                    									<div class="sw-field--checkbox">
                    										<div class="sw-field--checkbox__content">
                    											<div class="sw-field__checkbox">
                    												<input id="deleteSelectedRecipientgroup" type="checkbox" name="deleteSelectedRecipientgroup[]" value="{{ $value->id }}" data-id="{{ $value->id }}" class="deleteSelectedRecipientgroup"> 
                    												<div class="sw-field__checkbox-state">
           									...
           									<td class="sw-data-grid__cell sw-data-grid__cell--actions custom-recipientgroup-options" data-id="{{ $value->id }}">
           										<div class="sw-data-grid__cell-content">
			 ...
			 <div class="popup custom-delete-model recipientgroup-delete-popup">
				    ...
				    <div class="popup-content">
				     ...
				     <div class="sw-modal__body">
				      ...
				      <footer class="sw-modal__footer">
					      	<button class="sw-button sw-button--small recipientgroup-delete-popup-cancel">
					      		<span class="sw-button__content">
	                				Cancel
	            				</span>
	            			</button> 
	            			<button class="sw-button sw-button--danger sw-button--small recipientgroup-delete-popup-delete">
	            				<span class="sw-button__content">
	                				Delete
	            				</span>
	            			</button>
